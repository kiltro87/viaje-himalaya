...
const CACHE_NAME = 'viaje-himalaya-v3.2.5-debug-icons';
const DATA_CACHE = 'viaje-data-v3.2.5-debug-icons';
...
console.log('📱 Service Worker v3.2.5 cargado y listo - DEBUG UPSERT + CATEGORY ICONS');