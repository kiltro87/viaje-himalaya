...
const CACHE_NAME = 'viaje-himalaya-v4.0.3-id-mapping-fix';
const DATA_CACHE = 'viaje-data-v4.0.3-id-mapping-fix';
...
console.log('🔧 Service Worker v4.0.3 cargado - ID MAPPING FIX: Firebase DocID vs Campo ID resuelto');