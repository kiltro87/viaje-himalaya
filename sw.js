...
const CACHE_NAME = 'viaje-himalaya-v4.0.1-ui-fixes';
const DATA_CACHE = 'viaje-data-v4.0.1-ui-fixes';
...
console.log('🔧 Service Worker v4.0.1 cargado - UI FIXES: Dropdown Z-Index + Sync Indicators + Performance');