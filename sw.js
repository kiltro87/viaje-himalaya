...
const CACHE_NAME = 'viaje-himalaya-v4.0.2-logger-fix';
const DATA_CACHE = 'viaje-data-v4.0.2-logger-fix';
...
console.log('🐛 Service Worker v4.0.2 cargado - LOGGER FIX: Logger.performance → Logger.data/success');