...
const CACHE_NAME = 'viaje-himalaya-v3.2.4-true-upsert';
const DATA_CACHE = 'viaje-data-v3.2.4-true-upsert';
...
console.log('📱 Service Worker v3.2.4 cargado y listo - TRUE UPSERT WITH MERGE');