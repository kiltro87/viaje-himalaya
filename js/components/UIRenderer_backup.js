...
export class UIRenderer {
    ...
    // Renderizado de resumen ahora delegado a SummaryRenderer
    // El método se mantiene solo para compatibilidad, redirige al renderer especializado
    renderSummary() {
    ...
    // Los métodos calculateTotalBudget() y calculateTotalSpent() han sido movidos a SummaryRenderer
    ...
    // Método renderTripStyleAnalysis() movido a SummaryRenderer
    renderTripStyleAnalysis() {
        return this.summaryRenderer.renderTripStyleAnalysis();
    }

    // Métodos calculateTripStyles(), capitalizeFirst() y getStyleDescription() movidos a SummaryRenderer

    // Método renderFlightsSection() movido a SummaryRenderer
    renderFlightsSection() {
        return this.summaryRenderer.renderFlightsSection ? this.summaryRenderer.renderFlightsSection() : '';
    }

    // Método original renderFlightsSection (mantenido temporalmente para compatibilidad)
    renderFlightsSectionOld() {
        try {
