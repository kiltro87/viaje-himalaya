...
export class UIRenderer {
    ...
    constructor() {
        ...
        // Detectar breakpoint responsive inicial para optimización
    ...
    /**
     * Detectar breakpoint responsive actual
     * 
     * Analiza el ancho de la ventana actual y determina el breakpoint
     * de Tailwind CSS correspondiente. Esto permite optimizar el renderizado
     * y aplicar lógica específica según el tamaño de pantalla.
     * 
     ...
     * 
     * @returns {string} El breakpoint actual ('xs', 'sm', 'md', 'lg', 'xl', '2xl')
     */
    detectBreakpoint() {
        const width = window.innerWidth;
        let breakpoint = 'xs';
        
        // Determinar breakpoint basado en anchos de Tailwind CSS
        ...
        Logger.responsive(`Current breakpoint: ${breakpoint}`, { width, breakpoint });
        return breakpoint;
    }
     ...
     */
    renderMainContent() {
        Logger.ui('Starting main content render', { view: this.currentView });
        Logger.startPerformance(`render-${this.currentView}`);
        
        const mainContent = document.getElementById('main-content');
        if (!mainContent) {
            Logger.error('Main content element not found', { selector: '#main-content' });
            return;
        }
    ...
    /* ========================================
     * UTILIDADES DE FECHAS Y FORMATEO
     * ======================================== */

    /**
     * Obtener fecha específica del viaje
     * 
     * Calcula la fecha correspondiente a un día específico del viaje
     * basándose en la fecha de inicio y el número de día.
     * 
     ...
     * 
     * Convierte una fecha a formato "DD MMM" en español.
     * Útil para mostrar fechas compactas en la interfaz.
     * 
     ...
     * 
     * Utiliza Intl.NumberFormat para formatear cantidades en formato español
     * con símbolo de euro. Permite redondeo opcional para mostrar enteros.
     * 
                ...
                <section class="bg-white dark:bg-slate-800 rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg border border-slate-200 dark:border-slate-700">
                    <div class="flex items-center justify-between mb-8">
                        <div class="flex items-center gap-4">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 dark:bg-blue-900/20 rounded-2xl flex items-center justify-center">
                                <span class="material-symbols-outlined text-lg sm:text-xl text-blue-600 dark:text-blue-400">event_available</span>
                            </div>
                            <div>
